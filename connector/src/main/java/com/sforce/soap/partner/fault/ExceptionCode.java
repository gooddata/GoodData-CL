...
public class ExceptionCode implements java.io.Serializable {
    ...
    public static final String _CANT_ADD_STANDARD_PORTAL_USER_TO_TERRITORY = "CANT_ADD_STANDARD_PORTAL_USER_TO_TERRITORY";
    public static final String _CIRCULAR_OBJECT_GRAPH = "CIRCULAR_OBJECT_GRAPH";
    ...
    public static final String _CUSTOM_METADATA_LIMIT_EXCEEDED = "CUSTOM_METADATA_LIMIT_EXCEEDED";
    ...
    public static final String _INVALID_FILTER_VALUE = "INVALID_FILTER_VALUE";
    public static final String _INVALID_ID_FIELD = "INVALID_ID_FIELD";
    public static final String _INVALID_LOCALE_LANGUAGE = "INVALID_LOCALE_LANGUAGE";
    ...
    public static final String _NO_SOFTPHONE_LAYOUT = "NO_SOFTPHONE_LAYOUT";
    ...
    public static final String _PORTAL_NO_ACCESS = "PORTAL_NO_ACCESS";
    ...
    public static ExceptionCode fromValue(String value)
    ...
    public static ExceptionCode fromString(String value)
          throws IllegalArgumentException {
