...
public class CSVParser {
    ...
    // reusable stringbuilder to avoid unnecessary objects creation
    private final StringBuilder parsingStringBuider = new StringBuilder(INITIAL_READ_SIZE);
    ...
    */
    ...
    private String[] parseLine(String nextLine, boolean multi) throws IOException {
        ...
        StringBuilder sb = this.parsingStringBuider;
