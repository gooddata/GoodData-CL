...
LoadGoogleAnalytics(configFile=data/ga/ga.config.xml,username=user@gmail.com,password=password,profileId=ga:7468896,dimensions=ga:date|ga:browser,metrics=ga:visits|ga:pageviews,startDate=2010-01-01,endDate=2010-05-31);
